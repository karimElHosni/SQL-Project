...
let DatabaseController = class DatabaseController {
    ...
    configureRouter() {
        ...
        this.router.get('/plansrepas', (req, res) => __awaiter(this, void 0, void 0, function* () {
            this.databaseService.getPlansRepas()
                .then((repas) => {
                res.status(200).send(repas.rows);
            });
        }));
        this.router.get('/fournisseurs', (req, res) => __awaiter(this, void 0, void 0, function* () {
            this.databaseService.getSuppliers()
                .then((suppliers) => {
                res.status(200).send(suppliers.rows);
            });
        }));
        this.router.post('/insert', (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.body) {
                res.status(400).send();
                return;
            }
        ...
        this.router.delete('/options', (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.body) {
                res.status(400).send();
                return;
            }
        ...
        this.router.patch('/insert', (req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.body) {
                res.status(400).send();
                return;
            }
